...
let exp3 =
  "Jane loves her room because it's spacious but precious seldom visit her";
let regExp3 = /\w+ious\b/;
// regExp3 = regExp3.test
console.log(regExp3.test(exp3));

console.log("##################4"); //this is used to separate the output of each question

// 1.5 A whitespace character followed by a period, comma, colon, or semicolon
...
let longLetters =
  "people, Omolara, Variable, beneficial, judiciary Omolara Omolara";
let regExp5 = /\b\w{7,}\b/;
// let results = longLetters.replace("Omolara", "valuable")
...
let exp6 = "Bat, band, pet, Energy, book, beat";
...
const testNumbers = ["891", "-75", "+0.8", "7.", ".9", "2.51e-4", "7E10", "."];

let testNumbersExp = /^[+\-]?\d+(\.\d*)?([eE][+\-]?\d+)?$/;
testNumbers.forEach((num) => {
  const outputs = testNumbersExp.test(num);
